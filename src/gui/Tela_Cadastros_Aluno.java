...
//        Tela_Cadastros.setDefaultLocale(null);
        ...
        for(Pessoa pessoa: Banco.usuarios){
            if(pessoa instanceof Aluno){
                ...
                dtmProdutos.addRow(new Object[]{
                    ...
                    aluno.getEndereco(),
                    aluno.getTelefone(),
                    formato.format(aluno.getNascimento())
                });
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/teacher-giving-lecture.png"))); // NOI18N
    ...
    private void jLabel6MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MousePressed
        ...
        try {
            ...
            Logger.getLogger(Tela_Cadastros_Aluno.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel8MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MousePressed
        ...
        for(Pessoa pessoa: Banco.usuarios){
            if(pessoa.getMatricula().equals(txtMatricula.getText())){
                ...
                a.setSenha(jPasswordField1.getText());
        ...
        preencherTabela();
        JOptionPane.showMessageDialog(null, "Dados do usuário "+a.getNome()+" atualizados com sucesso");
        txtMatricula.setText(Banco.geradorDeMatricula('A'));
        txtNome.setText("");
        txtCPF.setText("");
